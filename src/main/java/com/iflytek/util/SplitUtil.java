...
//        SplitUtil.splitByPageSize(1, 3657, 50, (from1, to1,pageNum1) -> {
//            System.out.println(Thread.currentThread()+"当前页码:"+pageNum1+" "+from1 +" -> "+ to1);
//        });

        //SplitUtil.splitByPageNum(1,1000001,10,(from, to,pageNum) -> {
        //    //new Thread(() -> {
        //        SplitUtil.splitByPageSize(from, to, 1000, (from1, to1,pageNum1) -> {
        //            System.out.println(Thread.currentThread()+"当前页码:"+pageNum1+" "+from1 +" -> "+ to1);
        //        });
        //    //}).start();
        //});
